...
class GameManager:
    def __init__(self):
        ...
        self.mole = []
        self.mole.append(sprite_sheet.subsurface(676, 0, 360, 324))
        self.mole.append(sprite_sheet.subsurface(1236, 0, 360, 324))
        self.mole.append(sprite_sheet.subsurface(1800, 0, 360, 324))
        self.mole.append(sprite_sheet.subsurface(2300, 0, 464, 324))
        self.mole.append(sprite_sheet.subsurface(2868, 0, 464, 324))
        self.mole.append(sprite_sheet.subsurface(3412, 0, 464, 324))
        ...
        self.hole_positions.append((350, 500))
        self.hole_positions.append((850, 500))
        self.hole_positions.append((1325, 500))
        # Init debugger
    ...
    def update(self):
        ...
        level_test = self.font_obj.render(current_test, True, (0, 0, 0))
    ...
    def start(self):
        ...
        # if we are not using a video file, stop the camera video stream
            ...
            if self.countdown == 0:
                    loop = False
                    self.summery()
            if self.is_mole_hit(self.countercrush):
                self.countercrush = 0
                num = 3
                left = 14
                is_down = False
                ...
                # Stop popping sound effect                        self.soundEffect.stopPop()
                # Play hurt sound                    self.soundEffect.playHurt()
                self.update()

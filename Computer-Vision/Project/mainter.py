...
def detect_mole(image):
    ...
    lower_brown = np.array([0, 0, 100])  # Adjust these values based on your specific shade of brown
    upper_brown = np.array([50, 50, 255])   # Adjust these values based on your specific shade of brown
